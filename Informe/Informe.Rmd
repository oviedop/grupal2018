...
Presenta gráficos de presencia/ausencia en diferentes parcelas fijas, la ausencia la correlacionan como mortalidad de S. gigas. el trabajo se realizo en Punta Mala en el pacifico central de Costa Rica[@sutherland1986competition].
...
En donde se adaptó un modelo de crecimiento de von Bertalanffy a datos de juveniles específicamente, utilizando los siguientes parámetros: $L_\infty$ = 315 mm, K = 0.029 mo -1 , y t o = 0.5 meses. En el cual llegaron a observar que la apariencia de un labio delgado es considerado un criterio pobre para la madurez sexual y entre mayor sea este es recomendado para lograr la protección de las poblaciones bajo una fuerte presión de pesca y así mismo que las poblaciones de Galeatus pueden restablecerse con éxito [@Cipriani2008].

Por otra parte las poblaciones de Siphonaria gigas, también son alta mente consumidas y explotadas por el ser humano, debido a las características nutricionales y de crecimiento que presenta la especie [@Pinchuck2009].
